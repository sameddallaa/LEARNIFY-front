                            ...
                            <button
                              ...
                              onClick={async () =>
                                handleDelete(
                                  ...
                                  `http://localhost:8000/api/ressources/td/${chapitre.subject}/${chapitre.number}/${td.number}/delete/`,
                                )
                              }
                            >
                              Delete
                        ...
                        <div className="col-start-4 flex items-baseline justify-evenly space-x-2 py-2 ">
                          ...
                          {is_teacher && (
                            <button
                              ...
                              onClick={async () =>
                                handleDelete(
                                  `http://localhost:8000/api/ressources/tp/${chapitre.subject}/${chapitre.number}/${tp.number}/delete/`,
                          ...
                          <div className="flex flex-col items-center justify-center space-y-4">
                            {is_student ? (
                              ...
                              <button
                                ...
                                onClick={async () =>
                                  handleDelete(
                                    `http://localhost:8000/api/ressources/homework/${chapitre.subject}/${chapitre.number}/${devoir.number}/delete/`,
                        ...
                        <div className="flex items-baseline justify-evenly space-x-10 py-2 ">
                          ...
                          {is_teacher && (
                            <button
                              ...
                              onClick={async () =>
                                handleDelete(
                                  `http://localhost:8000/api/ressources/quizzes/${chapitre.subject}/${chapitre.number}/${quizze.number}/delete/`,
                  ...
                  {autreRs.map((rs) => (
                    <React.Fragment key={rs.id}>
                      <div className="flex justify-between">
                        <p className="inline justify-start pl-4 text-center text-[#26a69a]">
                          {rs.title}
                        </p>
                        <a
